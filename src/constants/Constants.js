...
export const initialBoard = new Board([
  new Pawn(new Position(0, 3), TeamType.WHITE),
  ...
  // new Pawn(new Position(0, 6), TeamType.BLACK, true),
  new Pawn(new Position(1, 4), TeamType.BLACK, true),
  // new Pawn(new Position(2, 6), TeamType.BLACK, true),
